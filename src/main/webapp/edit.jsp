    ...
    <body>
        ...
        <form class="form" action="EditServlet" method="post">
            <table>
                ...
                <tr><td>Full Name:</td><td><input type="text" value="<%= user.getName()%>" name="newName" ></td></tr>
                <tr><td>Password:</td><td><input type="password" value="<%= user.getPassword()%>" name="newPassword" ></td></tr>
                <td>
